...
namespace UChi.CourseEvals.Data.Migrations
{
    ...
    [Migration("20220318065606_AddIsVirtualProp")]
    partial class AddIsVirtualProp
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UChi.CourseEvals.Domain.Entities.ApiKey", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2022, 3, 18, 1, 56, 5, 897, DateTimeKind.Local).AddTicks(500),
                            Email = "test@test.com",
            ...
            modelBuilder.Entity("ProfessorSection", b =>
                {
                    b.HasOne("UChi.CourseEvals.Domain.Entities.Professor", null)
                        .WithMany()
